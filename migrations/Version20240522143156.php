 ...
 */
final class Version20240522143156 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE model CHANGE brand_id brand_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE model CHANGE brand_id brand_id INT NOT NULL');
    }
}
